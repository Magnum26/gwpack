...
$mail->Port = 587;
$mail->Username = "gwpackjewellery@gmail.com";
$mail->Password = "bvjq9Y2Jzxcm7u364HDF";
...
if( isset( $_POST['contactform-submit'] ) AND $_POST['contactform-submit'] == 'submit' ) {
    if( $_POST['contactform-name'] != '' AND $_POST['contactform-email'] != '' AND $_POST['contactform-message'] != '' ) {
        ...
        $toemail = 'gwpackjewellery@gmail.com'; // Your Email Address
        $toname = 'G W Pack Jewellery'; // Your Name
